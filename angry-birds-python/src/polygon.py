...
class Polygon():
    def __init__(self, pos, length, height, space, mass=5.0):
        ...
        self.body = body
        self.shape = shape
        wood = pygame.image.load("/home/rasika/DNT_vision_games/angry-birds-python/resources/images/wood.png").convert_alpha()
        wood2 = pygame.image.load("/home/rasika/DNT_vision_games/angry-birds-python/resources/images/wood2.png").convert_alpha()
